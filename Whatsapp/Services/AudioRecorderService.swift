...
//    deinit {
//        tearDown()
//        print("AudioRecorderService: has been deinitialized")
//        audioRecorder = nil
//        timer?.cancel() // Ensure the timer is canceled on deinit
//    }
//
//    func startRecording() {
//        /// Setup Audio Session
...
//                print("AudioRecorderService: elapsedTime: \(self.elapsedTime)")
//            }
//    }
//
//    func tearDown() {
...
final class AudioRecorderService {
    ...
    func tearDown() {
        // Stop recording if active, sync mode
        if isRecording {
            audioRecorder?.stop()
            isRecording = false
            timer?.cancel()
